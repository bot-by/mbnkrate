...
public interface CurrencyRate {
   ...
   *
   * @return timestamp when a rate was updated
   */
  Instant getDate();
   ...
   * The Monobank buys.
   *
   * @return rate to sell to the bank
   */
  BigDecimal getRateBuy();

  /**
   * The cross rate by third currency, usually USD.
   *
   * @return cross rate
   */
   ...
   * The Monobank sells.
   *
   * @return rate to buy from the bank
   */
