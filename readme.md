...
```
cd existing_repo
git remote add origin https://gitlab.com/bot-by/monobank/mbnkrate.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/bot-by/monobank/mbnkrate/-/settings/integrations)
